...
OPTIONS = ["choose internet source"] + network
OPTIONS1 = ["choose hotspot source"] + network
OPTIONS2 = [
...
# ' ' + '--isolate-clients' +
    if bridge in ('bridge mode'):
        if internet in ('internet hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + '-m bridge' + ' ' + variable.get(
                    ) + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('bridge mode'):
        if internet in ('internet hotspot'):
            if sec in ('ieee 80211n mode'):
                if client in ('client'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + '-m bridge' + ' ' + '--ieee80211n --ht_capab [HT40+] ' + ' ' + variable.get(
                    ) + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('bridge mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('ieee 80211n mode'):
                if client in ('client'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + '-m bridge' + ' ' + '-n' + ' ' +
                                                          '--ieee80211n --ht_capab [HT40+] ' + ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    ...
    if bridge in ('bridge mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + '-m bridge' + ' ' + '-n' +
                                                          ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('internet hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + ' ' + variable.get(
                    ) + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('internet hotspot'):
            if sec in ('ieee 80211n mode'):
                if client in ('client'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + ' ' + '-n' + ' ' + '--ieee80211n --ht_capab [HT40+] ' + ' ' + variable.get(
                    ) + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('ieee 80211n mode'):
                if client in ('client'):
                    subprocess.call(shlex.split('./create_ap.sh ' + ' ' + '-n' + ' ' + '--ieee80211n --ht_capab [HT40+] ' + ' ' + variable.get(
                    ) + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client'):
                    subprocess.call(shlex.split('./create_ap.sh ' + ' ' + '-n' + variable.get(
                    ) + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
# ---------------------------------------------------------------------------------------
        ...
        if internet in ('internet hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client-islation'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + '-m bridge' + ' ' + '--isolate-clients' +
                                                          ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('bridge mode'):
    ...
    if bridge in ('bridge mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('ieee 80211n mode'):
                if client in ('client-islation'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + '-m bridge' + ' ' + '--isolate-clients' + ' ' + '-n' + ' ' +
                                                          '--ieee80211n --ht_capab [HT40+] ' + ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    ...
    if bridge in ('bridge mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client-islation'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + '-m bridge' + ' ' + '--isolate-clients' +
                                                          ' ' + '-n' + ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('internet hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client-islation'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + ' ' + '--isolate-clients' +
                                                          ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('internet hotspot'):
            if sec in ('ieee 80211n mode'):
                if client in ('client-islation'):
                    process = subprocess.call(shlex.split('./create_ap.sh ' + ' ' + '--isolate-clients' + ' ' + '-n' + ' ' +
                                                          '--ieee80211n --ht_capab [HT40+] ' + ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('ieee 80211n mode'):
                if client in ('client-islation'):
                    subprocess.call(shlex.split('./create_ap.sh ' + ' ' + '--isolate-clients' + ' ' + '-n' + ' ' +
                                                '--ieee80211n --ht_capab [HT40+] ' + ' ' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
    if bridge in ('no-bridge-mode'):
        if internet in ('no-internet-hotspot'):
            if sec in ('no-ieee-80211n-mode'):
                if client in ('client-islation'):
                    subprocess.call(shlex.split('./create_ap.sh ' + ' ' + '--isolate-clients' + ' ' +
                                                '-n' + variable.get() + ' ' + variable1.get() + ' ' + e1.get() + ' ' + e2.get() + ''))
    else:
        pass
